...
require.register("magic/index.js", function(exports, require, module){
// Dependencies
var $ = require('jquery');
...
function Magic() {
	...
	$inputs.change(function() {
		...
		$curlTries.each(function() {
			...
			curl = ($article.hasClass('POST')) ? 'curl --user ' + apiToken + ': -d "' + dataStr + '" ' + baseUrl + path : ($article.hasClass('DELETE')) ? 'curl -X DELETE --user ' + apiToken + ': -d "' + dataStr + '" ' + baseUrl + path : 'curl --user ' + apiToken + ': "' + baseUrl + path + '?' + dataStr + '"';
			$(this).text(curl);
		});
...
require.alias("magic/index.js", "boot/deps/magic/index.js");
require.alias("component-jquery/index.js", "magic/deps/jquery/index.js");
